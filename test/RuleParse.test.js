...
define(["parser"], function(parser) {
    ...
    console.log("(aaa&&bbb) || (ccc&&ddd)", parser.parse("(aaa&&bbb) || (ccc&&ddd)"))
    console.log("(aaa&&bbb) || (ccc&&ddd) || (ccc&&ddd)", parser.parse("(aaa&&bbb) || (ccc&&ddd) || (eee&&fff)"))
    ...
    console.log("((aaa&&bbb||(iuo[123]||bbc[iop])) && (ccc&&ddd) && (eee&&fff[1234]) || (ggg&&hhh[xxxx])) || (aaa[1234]&&bbb) && (ccc&&ddd) && (eee&&fff) || (ggg&&hhh)", parser.parse("((aaa&&bbb||(iuo[123]||bbc[iop])) && (ccc&&ddd) && (eee&&fff[1234]) || (ggg&&hhh[xxxx])) || (aaa[1234]&&bbb) && (ccc&&ddd) && (eee&&fff) || (ggg&&hhh)"))
})
